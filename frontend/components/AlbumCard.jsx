      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="space-x-2">
            <button onClick={() => onView(album)} className="text-blue-600 hover:text-blue-800 text-sm font-medium">
              View
            </button>
            <button onClick={() => onDelete(album._id)} className="text-red-600 hover:text-red-800 text-sm font-medium">
              Delete
            </button>
          </div>
        </div>
